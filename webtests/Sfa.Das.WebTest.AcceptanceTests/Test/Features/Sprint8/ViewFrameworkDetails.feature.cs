...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Food and Drink: Meat and Poultry Industry Skills", "Food and Drink", "Meat and Poultry Industry Skills", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Food and Drink: Baking Industry Skills", "Food and Drink", "Baking Industry Skills", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Food and Drink: Fish and Shellfish Industry Skills", "Food and Drink", "Fish and Shellfish Industry Skills", new string[0])]
