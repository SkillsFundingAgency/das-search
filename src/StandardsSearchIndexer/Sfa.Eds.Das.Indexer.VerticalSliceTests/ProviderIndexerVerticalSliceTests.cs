namespace Sfa.Eds.Das.Indexer.VerticalSliceTests
{
    ...
    public class ProviderIndexerVerticalSliceTests
    {
        ...
        private Mock<IMaintainSearchIndexes<Provider>> _mockSearchIndex;
        ...
        public void Setup()
        {
            ...
            _mockSearchIndex = new Mock<IMaintainSearchIndexes<Core.Models.Provider.Provider>>();
            ...
            _container.Configure(x => x.For<IMaintainSearchIndexes<Core.Models.Provider.Provider>>().Use(_mockSearchIndex.Object));
