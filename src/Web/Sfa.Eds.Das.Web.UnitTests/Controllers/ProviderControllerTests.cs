...
namespace Sfa.Eds.Das.Web.Controllers.Tests
{
    ...
    public class ProviderControllerTests
    {
        ...
        public async Task SearchResultsShouldReturnViewResultWhenSearchIsSuccessful()
        {
            ...
            var controller = new ProviderController(mockProviderSearchService.Object, mockLogger.Object, mockMappingService.Object, null, null, mockStandardRepository.Object);
