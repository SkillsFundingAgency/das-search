    ...
    public class MappingService : IMappingService
    {
        ...
        private static void CreateProviderDetailsMappings(IMapperConfiguration cfg)
        {
            ...
            cfg.CreateMap<DetailProviderResponse, ApprenticeshipDetailsViewModel>()
                   ...
                   .ForMember(x => x.AchievementRateMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.ApprenticeshipDetails.Product.AchievementRate, z.ApprenticeshipDetails.Provider.Hei)))
                   .ForMember(x => x.AchievementRate, y => y.MapFrom(z => z.ApprenticeshipDetails.Product.AchievementRate))
                   .ForMember(x => x.NationalAchievementRateMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.ApprenticeshipDetails.Product.NationalAchievementRate, z.ApprenticeshipDetails.Provider.Hei)))
            ...
            cfg.CreateMap<StandardProviderSearchResultsItem, StandardProviderResultItemViewModel>()
                ...
                .ForMember(x => x.EmployerSatisfactionMessage, y => y.ResolveUsing<EmployerSatisfactionResolver>().FromMember(z => z.EmployerSatisfaction))
                .ForMember(x => x.LearnerSatisfactionMessage, y => y.ResolveUsing<EmployerSatisfactionResolver>().FromMember(z => z.LearnerSatisfaction))
                .ForMember(x => x.AchievementRateMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.OverallAchievementRate, z.Hei)))
            ...
            .ForMember(x => x.AchievementRateMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.Product.AchievementRate, z.Provider.Hei)))
            .ForMember(x => x.AchievementRate, y => y.MapFrom(z => z.Product.AchievementRate))
            .ForMember(x => x.NationalAchievementRateMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.Product.NationalAchievementRate, z.Provider.Hei)))
