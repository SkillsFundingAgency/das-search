    ...
    public class MappingService : IMappingService
    {
        ...
        private static void CreateProviderDetailsMappings(IMapperConfiguration cfg)
        {
            ...
            cfg.CreateMap<DetailProviderResponse, ApprenticeshipDetailsViewModel>()
                   ...
                   .ForMember(dest => dest.Hei, opt => opt.MapFrom(source => source.ApprenticeshipDetails.Provider.Hei))
                   ...
                   .ForMember(x => x.EmployerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.ApprenticeshipDetails.Product.EmployerSatisfaction, z.ApprenticeshipDetails.Provider.Hei)))
            .ForMember(x => x.LearnerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.ApprenticeshipDetails.Product.LearnerSatisfaction, z.ApprenticeshipDetails.Provider.Hei)))
            ...
            cfg.CreateMap<IApprenticeshipProviderSearchResultsItem, StandardProviderResultItemViewModel>()
                .ForMember(x => x.EmployerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.EmployerSatisfaction, z.Hei)))
                .ForMember(x => x.LearnerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.LearnerSatisfaction, z.Hei)))
            ...
            .ForMember(dest => dest.Hei, opt => opt.MapFrom(source => source.Provider.Hei))
            ...
            .ForMember(x => x.EmployerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.Product.EmployerSatisfaction, z.Provider.Hei)))
            .ForMember(x => x.LearnerSatisfactionMessage, y => y.MapFrom(z => ProviderMappingHelper.GetPercentageText(z.Product.LearnerSatisfaction, z.Provider.Hei)))
