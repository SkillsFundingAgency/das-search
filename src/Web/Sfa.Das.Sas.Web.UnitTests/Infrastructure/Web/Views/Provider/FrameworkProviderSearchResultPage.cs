...
namespace Sfa.Das.Sas.Web.UnitTests.Infrastructure.Web.Views.Provider
{
    ...
    public sealed class FrameworkProviderSearchResultPage : ViewTestBase
    {
        ...
        public void ShouldShowZeroResultsMessageWhenThereAreNoResults()
        {
            ...
            this.GetPartial(html, ".result-message").Should().Contain("Sorry, there are currently no training providers for Test name: Pathway test name, level 3 for 'TESTPOSTCODE'.");
        }
        ...
        public void ShouldAddIntervalToResultsForGoogleAnalytics(int resultIndex, string expectedText, int acctualPage)
        {
            ...
            var results = from ll in new FrameworkProviderResultItemViewModel[10]
                          select new FrameworkProviderResultItemViewModel { ProviderName = "Test" };
