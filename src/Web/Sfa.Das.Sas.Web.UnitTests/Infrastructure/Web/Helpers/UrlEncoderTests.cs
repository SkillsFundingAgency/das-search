...
namespace Sfa.Das.Sas.Web.UnitTests.Infrastructure.Web.Helpers
{
    ...
    public class UrlEncoderTests
    {
        ...
        [TestCase("C.M.S.VOCATIONAL TRAINING LIMITED", "cmsvocational-training-limited")]
        ...
        [TestCase("E.QUALITY TRAINING LIMITED", "equality-training-limited")]
        ...
        [TestCase("L.I.T.S.LIMITED", "litslimited")]
        [TestCase("NORTH LANCS.TRAINING GROUP LIMITED(THE)", "north-lancstraining-group-limited-the")]
        ...
        [TestCase("ST.PATRICK'S INTERNATIONAL COLLEGE LIMITED", "stpatricks-international-college-limited")]
