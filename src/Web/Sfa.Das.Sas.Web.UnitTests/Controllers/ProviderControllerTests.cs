...
namespace Sfa.Das.Sas.Web.UnitTests.Controllers
{
    ...
    public class ProviderControllerTests
    {
        ...
        public async Task SearchResultsShouldReturnViewResultWhenStandardSearchIsSuccessful()
        {
            ...
            _mockProviderSearchService.Setup(x => x.SearchStandardProviders(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<Pagination>(), It.IsAny<IEnumerable<string>>(), It.IsAny<bool>()))
                .Returns(Task.FromResult(searchResults));
            _mockProviderSearchService.Setup(x => x.SearchStandardProviders(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<Pagination>(), It.IsAny<IEnumerable<string>>(), true))
                .Returns(Task.FromResult(searchResults));
        ...
        public async Task SearchResultsShouldReturnViewResultWhenFrameworkSearchIsSuccessful()
        {
            ...
            _mockProviderSearchService.Setup(x => x.SearchFrameworkProviders(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<Pagination>(), It.IsAny<IEnumerable<string>>(), It.IsAny<bool>()))
                .Returns(Task.FromResult(searchResults));
            _mockProviderSearchService.Setup(x => x.SearchFrameworkProviders(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<Pagination>(), It.IsAny<IEnumerable<string>>(), true))
                .Returns(Task.FromResult(searchResults));
            _mockMappingService.Setup(
                x =>
